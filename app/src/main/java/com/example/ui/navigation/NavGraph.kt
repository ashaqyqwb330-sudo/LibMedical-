        ...
        composable("study_plan") {
            StudyPlanScreen(
                ...
                onSemesterClick = { semesterId ->
                    navController.navigate("semester/$semesterId")
                },
                onMedicalSystemsClick = {
                    navController.navigate("medical_systems")
                }
            )
        }
        composable(
        ...
        composable(
            ...
            CourseDetailScreen(
                ...
                onContentClick = { index ->
                    navController.navigate("course_content/$courseId/$index")
                }
            )
        }
        composable(
